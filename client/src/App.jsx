...
import './style.css';
import LoanHistory from './components/LoanHistory'; // Assurez-vous que ce chemin est correct
import ReturnBooks from './components/ReturnBooks'; // Assurez-vous que le chemin est correct
...
function App() {
    ...
    return (
        <Router basename={base === "/" || "http://localhost:3000/" ? "/" : `/${base}`}>
            <Routes>
                <Route path="/" element={<Template userT={userT}><DashBoard /></Template>} />
                ...
                <Route path="/loan-history" element={<Template userT={userT} page="Historique des Emprunts"><LoanHistory /></Template>} />
                <Route path="/return-books" element={<Template userT={userT} page="Retourner un Livre"><ReturnBooks /></Template>} />
